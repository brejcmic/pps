...
INI_TIM2IER     equ     %00000001       ; preruseni UIE
...
smycka  jp      smycka                  ; prazdna smycka
				
				
tim2isr bres    TIM2_SR1, #0            ; shozeni vlajky UIF
        bcpl    PB_ODR, #0              ; negace bitu 0
        iret                            ; opusteni obsluhy
