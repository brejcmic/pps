...
% =====================================================================================================================
	\begin{frame}
    \frametitle{D klopný obvod - hradlo 74xx74}
		\small
		\begin{minipage}[t][\textheight][t]{0.4\textwidth}
			\vspace{5mm}
			\textbf{Symbol:}
			\begin{center}
				\includegraphics[width=0.50\textwidth]{fig/D_KO_hradlo.png}
			\end{center}
			
			\begin{itemize}
				\item $S$ a $R$ jsou asynchronní vstupy.
			\end{itemize}
		...
		\begin{center}
			...
			\begin{itemize}
				\item Reakce na hranu je značena trojúhelníčkem:
				
				\begin{itemize}
					\item uvnitř symbolu = náběžná hrana,
					\item vně symbolu = sestupná hrana
				\end{itemize}
			\end{itemize}
