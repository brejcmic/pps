...
main.l	mov     PB_ODR, #INI_PB_ODR     ; stav vystupu pinu
        ...
        ; inicializace indexu
index   clrw    X                       ; X = 0x0000
        
        ; smycka programu
smycka  ld      A, (pole,X)             ; A = pole[X]
        cpl     A                       ; negace A
        ld      PB_ODR, A               ; vystup LED = A
        incw    X                       ; X = X+1 (16 bit)
        call    wait                    ; cekat 0,5 s
        cpw     X,#{poleKon-pole}       ; je konec pole?
                                        ; Slozene zavorky !!
        jrult   smycka                  ; skok na smycka
                                        ; pri X < delka pole
        jp      index                   ; skok na novou
                                        ; inicializaci X

        ; definice pole v pameti ROM
        ; kazdy radek reprezentuje jeden stav LED
pole    dc.b    %00000000
        dc.b    %10000000
        dc.b    %01000000
        dc.b    %00100000
        ...
        dc.b    %00000010
        dc.b    %00000001
poleKon dc.b    %11111111 ; posledni radek se nepouzije
