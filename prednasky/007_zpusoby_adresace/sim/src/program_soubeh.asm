...
; globalni promenne pro posun vlevo a posun vpravo
levyP   ds.b    1                       ; rezervace 1 byte
pravyP  ds.b    1                       ; rezervace 1 byte
...
inihod  mov     levyP, #%00000001       ; levyP = 00000001
        mov     pravyP, #%10000000      ; pravyP = 10000000
        
        ; smycka programu
smycka  ld      A, levyP                ; A = levyP
        add     A, pravyP               ; A = A + pravyP
        cpl     A                       ; negace A
        ld      PB_ODR, A               ; vystup LED = A
        call    wait                    ; cekat 0,5 s
        sll     levyP                   ; bitovy pos. vlevo
        srl     pravyP                  ; bitovy pos. vpravo

        jreq    inihod                  ; skok na inihod
                                        ; pri pravyP = 0
        jp      smycka                  ; skok na smycka
