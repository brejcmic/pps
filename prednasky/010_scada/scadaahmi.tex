\section{\texorpdfstring{HMI, SCADA a OPC}{HMI, SCADA a OPC}}
...
% =====================================================================================================================
	\begin{frame}
    \frametitle{HMI - příklad ovládání budiče}
		
		\begin{center}
			\includegraphics[width=1.00\textwidth]{fig/hmi_budic_sk.png}
		\end{center}
...
% =====================================================================================================================
	\begin{frame}
    \frametitle{SCADA - příklad testovací laboratoř H2}
		
		\begin{center}
			\includegraphics[width=1.00\textwidth]{fig/scada_H2_LAB.png}
		\end{center}
...
% =====================================================================================================================
	\begin{frame}
    \frametitle{OPC UA - klient UAExpert}
		
		\begin{center}
			\includegraphics[width=1.00\textwidth]{fig/UAExpert.png}
		\end{center}
...
% =====================================================================================================================
	\begin{frame}
    \frametitle{OPC UA - server v Python}
		
		\begin{center}
			\includegraphics[width=0.80\textwidth]{fig/opc_server_python.png}
		\end{center}
